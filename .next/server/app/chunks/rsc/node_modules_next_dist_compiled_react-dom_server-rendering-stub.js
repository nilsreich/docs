(self.TURBOPACK = self.TURBOPACK || []).push(["chunks/rsc/node_modules_next_dist_compiled_react-dom_server-rendering-stub.js", {

"[project-with-next]/node_modules/next/dist/compiled/react-dom/server-rendering-stub.js (ecmascript, rsc)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {

'use strict';
if (process.env.NODE_ENV === 'production') {
    module.exports = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react-dom/cjs/react-dom-server-rendering-stub.production.min.js (ecmascript, rsc)");
} else {
    module.exports = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react-dom/cjs/react-dom-server-rendering-stub.development.js (ecmascript, rsc)");
}
...
//# sourceMappingURL=node_modules_next_dist_compiled_react-dom_server-rendering-stub.js.map