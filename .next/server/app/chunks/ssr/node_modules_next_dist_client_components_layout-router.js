(self.TURBOPACK = self.TURBOPACK || []).push(["chunks/ssr/node_modules_next_dist_client_components_layout-router.js", {

"[project-with-next]/node_modules/next/dist/client/components/layout-router.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _interop_require_wildcard = __turbopack_require__("[project-with-next]/node_modules/@swc/helpers/lib/_interop_require_wildcard.js (ecmascript, ssr)").default;
var _react = _interop_require_wildcard(__turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react/index.js (ecmascript, ssr)"));
var _appRouterContext = __turbopack_require__("[project-with-next]/node_modules/next/dist/shared/lib/app-router-context.js (ecmascript, ssr)");
var _appRouter = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/app-router.js (ecmascript, ssr)");
var _infinitePromise = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/infinite-promise.js (ecmascript, ssr)");
var _errorBoundary = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/error-boundary.js (ecmascript, ssr)");
...
var _navigation = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/navigation.js (ecmascript, ssr)");
...
function InnerLayoutRouter({ parallelRouterKey , url , childNodes , childProp , segmentPath , tree , path , rootLayoutIncluded  }) {
    ...
    return rootLayoutIncluded ? _react.default.createElement("div", {
...
var _async_to_generator = __turbopack_require__("[project-with-next]/node_modules/@swc/helpers/lib/_async_to_generator.js (ecmascript, ssr)").default;
var _interop_require_wildcard = __turbopack_require__("[project-with-next]/node_modules/@swc/helpers/lib/_interop_require_wildcard.js (ecmascript, ssr)").default;
var _react = _interop_require_wildcard(__turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react/index.js (ecmascript, ssr)"));
var _client = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react-server-dom-webpack/client.js (ecmascript, ssr)");
var _appRouterContext = __turbopack_require__("[project-with-next]/node_modules/next/dist/shared/lib/app-router-context.js (ecmascript, ssr)");
var _reducer = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/reducer.js (ecmascript, ssr)");
var _hooksClientContext = __turbopack_require__("[project-with-next]/node_modules/next/dist/shared/lib/hooks-client-context.js (ecmascript, ssr)");
var _useReducerWithDevtools = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/use-reducer-with-devtools.js (ecmascript, ssr)");
var _errorBoundary = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/error-boundary.js (ecmascript, ssr)");
var _appRouterHeaders = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/app-router-headers.js (ecmascript, ssr)");
function AppRouter(props) {
    return _react.default.createElement(_errorBoundary.ErrorBoundary, {
        errorComponent: _errorBoundary.GlobalErrorComponent
    }, _react.default.createElement(Router, Object.assign({}, props)));
}
'use client';
...
const HotReloader = process.env.NODE_ENV === 'production' ? null : __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/hot-reloader-client.js (ecmascript, ssr)").default;
...
function Router({ initialHead , initialTree , initialCanonicalUrl , children , assetPrefix  }) {
    const initialState = (0, _react).useMemo(()=>{
        return {
            ...
            canonicalUrl: typeof window !== 'undefined' ? (0, _reducer).createHrefFromUrl(new URL(window.location.href)) : initialCanonicalUrl
        };
    }, [
        children,
        initialCanonicalUrl,
    ...
    }, initialHead, cache.subTreeData) : _react.default.createElement(_react.default.Fragment, null, initialHead, cache.subTreeData))))));
}
if ((typeof exports.default === 'function' || typeof exports.default === 'object' && exports.default !== null) && typeof exports.default.__esModule === 'undefined') {
    Object.defineProperty(exports.default, '__esModule', {
        value: true
...
"[project-with-next]/node_modules/next/dist/client/components/infinite-promise.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/error-boundary.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _react = _interop_require_default(__turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react/index.js (ecmascript, ssr)"));
...
function GlobalErrorComponent() {
    return _react.default.createElement("html", null, _react.default.createElement("body", null, _react.default.createElement("div", {
        style: styles.error
...
"[project-with-next]/node_modules/next/dist/client/components/match-segments.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/navigation.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _react = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react/index.js (ecmascript, ssr)");
var _appRouterContext = __turbopack_require__("[project-with-next]/node_modules/next/dist/shared/lib/app-router-context.js (ecmascript, ssr)");
var _hooksClientContext = __turbopack_require__("[project-with-next]/node_modules/next/dist/shared/lib/hooks-client-context.js (ecmascript, ssr)");
var _staticGenerationBailout = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/static-generation-bailout.js (ecmascript, ssr)");
...
"[project-with-next]/node_modules/next/dist/client/components/reducer.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
function fillCacheWithNewSubTreeData(newCache, existingCache, flightDataPath) {
    ...
    if (isLastEntry) {
        if (!childCacheNode || !childCacheNode.data || childCacheNode === existingChildCacheNode) {
            ...
            fillLazyItemsTillLeafWithHead(childCacheNode, existingChildCacheNode, flightDataPath[2], undefined);
...
"[project-with-next]/node_modules/next/dist/client/components/use-reducer-with-devtools.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/hot-reloader-client.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _formatWebpackMessages = _interop_require_default(__turbopack_require__("[project-with-next]/node_modules/next/dist/client/dev/error-overlay/format-webpack-messages.js (ecmascript, ssr)"));
var _navigation = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/navigation.js (ecmascript, ssr)");
var _errorOverlayReducer = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/error-overlay-reducer.js (ecmascript, ssr)");
var _parseStack = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/parseStack.js (ecmascript, ssr)");
var _reactDevOverlay = _interop_require_default(__turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/ReactDevOverlay.js (ecmascript, ssr)"));
var _useErrorHandler = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/use-error-handler.js (ecmascript, ssr)");
var _useWebsocket = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/use-websocket.js (ecmascript, ssr)");
...
"[project-with-next]/node_modules/next/dist/client/components/static-generation-bailout.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _staticGenerationAsyncStorage = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/static-generation-async-storage.js (ecmascript, ssr)");
...
"[project-with-next]/node_modules/next/dist/client/components/redirect.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/not-found.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/error-overlay-reducer.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/parseStack.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _stacktraceParser = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/stacktrace-parser/stack-trace-parser.cjs.js (ecmascript, ssr)");
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/ReactDevOverlay.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _interop_require_wildcard = __turbopack_require__("[project-with-next]/node_modules/@swc/helpers/lib/_interop_require_wildcard.js (ecmascript, ssr)").default;
var React = _interop_require_wildcard(__turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react/index.js (ecmascript, ssr)"));
var _errorOverlayReducer = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/error-overlay-reducer.js (ecmascript, ssr)");
var _shadowPortal = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/ShadowPortal.js (ecmascript, ssr)");
var _buildError = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/container/BuildError.js (ecmascript, ssr)");
var _errors = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/container/Errors.js (ecmascript, ssr)");
var _base = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/styles/Base.js (ecmascript, ssr)");
var _componentStyles = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/styles/ComponentStyles.js (ecmascript, ssr)");
var _cssReset = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/styles/CssReset.js (ecmascript, ssr)");
var _parseStack = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/parseStack.js (ecmascript, ssr)");
var _rootLayoutError = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/container/RootLayoutError.js (ecmascript, ssr)");
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/use-error-handler.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/use-websocket.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _react = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react/index.js (ecmascript, ssr)");
var _appRouterContext = __turbopack_require__("[project-with-next]/node_modules/next/dist/shared/lib/app-router-context.js (ecmascript, ssr)");
var _getSocketProtocol = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/get-socket-protocol.js (ecmascript, ssr)");
...
"[project-with-next]/node_modules/next/dist/client/components/hooks-server-context.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/static-generation-async-storage.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/ShadowPortal.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _interop_require_wildcard = __turbopack_require__("[project-with-next]/node_modules/@swc/helpers/lib/_interop_require_wildcard.js (ecmascript, ssr)").default;
var React = _interop_require_wildcard(__turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react/index.js (ecmascript, ssr)"));
var _reactDom = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react-dom/server-rendering-stub.js (ecmascript, ssr)");
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/container/BuildError.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _interop_require_wildcard = __turbopack_require__("[project-with-next]/node_modules/@swc/helpers/lib/_interop_require_wildcard.js (ecmascript, ssr)").default;
var React = _interop_require_wildcard(__turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react/index.js (ecmascript, ssr)"));
var _dialog = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Dialog/index.js (ecmascript, ssr)");
var _overlay = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Overlay/index.js (ecmascript, ssr)");
var _terminal = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Terminal/index.js (ecmascript, ssr)");
var _noopTemplate = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/noop-template.js (ecmascript, ssr)");
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/container/Errors.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _errorOverlayReducer = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/error-overlay-reducer.js (ecmascript, ssr)");
var _dialog = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Dialog/index.js (ecmascript, ssr)");
var _leftRightDialogHeader = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/LeftRightDialogHeader/index.js (ecmascript, ssr)");
var _overlay = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Overlay/index.js (ecmascript, ssr)");
var _toast = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Toast/index.js (ecmascript, ssr)");
var _getErrorByType = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/getErrorByType.js (ecmascript, ssr)");
var _nodeStackFrames = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/nodeStackFrames.js (ecmascript, ssr)");
var _noopTemplate = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/noop-template.js (ecmascript, ssr)");
var _closeIcon = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/icons/CloseIcon.js (ecmascript, ssr)");
var _runtimeError = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/container/RuntimeError.js (ecmascript, ssr)");
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/styles/Base.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/styles/ComponentStyles.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _interop_require_wildcard = __turbopack_require__("[project-with-next]/node_modules/@swc/helpers/lib/_interop_require_wildcard.js (ecmascript, ssr)").default;
var React = _interop_require_wildcard(__turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react/index.js (ecmascript, ssr)"));
var _styles = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/CodeFrame/styles.js (ecmascript, ssr)");
var _dialog = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Dialog/index.js (ecmascript, ssr)");
var _styles1 = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/LeftRightDialogHeader/styles.js (ecmascript, ssr)");
var _styles2 = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Overlay/styles.js (ecmascript, ssr)");
var _styles3 = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Terminal/styles.js (ecmascript, ssr)");
var _toast = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Toast/index.js (ecmascript, ssr)");
var _buildError = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/container/BuildError.js (ecmascript, ssr)");
var _rootLayoutError = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/container/RootLayoutError.js (ecmascript, ssr)");
var _errors = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/container/Errors.js (ecmascript, ssr)");
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/styles/CssReset.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/container/RootLayoutError.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/get-socket-protocol.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Dialog/index.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _dialog = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Dialog/Dialog.js (ecmascript, ssr)");
var _dialogBody = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Dialog/DialogBody.js (ecmascript, ssr)");
var _dialogContent = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Dialog/DialogContent.js (ecmascript, ssr)");
var _dialogHeader = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Dialog/DialogHeader.js (ecmascript, ssr)");
var _styles = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Dialog/styles.js (ecmascript, ssr)");
if ((typeof exports.default === 'function' || typeof exports.default === 'object' && exports.default !== null) && typeof exports.default.__esModule === 'undefined') {
    Object.defineProperty(exports.default, '__esModule', {
        value: true
    });
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Overlay/index.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _overlay = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Overlay/Overlay.js (ecmascript, ssr)");
if ((typeof exports.default === 'function' || typeof exports.default === 'object' && exports.default !== null) && typeof exports.default.__esModule === 'undefined') {
    Object.defineProperty(exports.default, '__esModule', {
        value: true
    });
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Terminal/index.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _terminal = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Terminal/Terminal.js (ecmascript, ssr)");
if ((typeof exports.default === 'function' || typeof exports.default === 'object' && exports.default !== null) && typeof exports.default.__esModule === 'undefined') {
    Object.defineProperty(exports.default, '__esModule', {
        value: true
    });
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/noop-template.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/LeftRightDialogHeader/index.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _leftRightDialogHeader = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/LeftRightDialogHeader/LeftRightDialogHeader.js (ecmascript, ssr)");
var _styles = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/LeftRightDialogHeader/styles.js (ecmascript, ssr)");
if ((typeof exports.default === 'function' || typeof exports.default === 'object' && exports.default !== null) && typeof exports.default.__esModule === 'undefined') {
    Object.defineProperty(exports.default, '__esModule', {
        value: true
    });
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Toast/index.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _styles = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Toast/styles.js (ecmascript, ssr)");
var _toast = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Toast/Toast.js (ecmascript, ssr)");
if ((typeof exports.default === 'function' || typeof exports.default === 'object' && exports.default !== null) && typeof exports.default.__esModule === 'undefined') {
    Object.defineProperty(exports.default, '__esModule', {
        value: true
    });
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/getErrorByType.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _errorOverlayReducer = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/error-overlay-reducer.js (ecmascript, ssr)");
var _nodeStackFrames = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/nodeStackFrames.js (ecmascript, ssr)");
var _stackFrame = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/stack-frame.js (ecmascript, ssr)");
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/nodeStackFrames.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/icons/CloseIcon.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/container/RuntimeError.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _interop_require_wildcard = __turbopack_require__("[project-with-next]/node_modules/@swc/helpers/lib/_interop_require_wildcard.js (ecmascript, ssr)").default;
var React = _interop_require_wildcard(__turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react/index.js (ecmascript, ssr)"));
var _codeFrame = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/CodeFrame/index.js (ecmascript, ssr)");
var _noopTemplate = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/noop-template.js (ecmascript, ssr)");
var _stackFrame = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/stack-frame.js (ecmascript, ssr)");
const CallStackFrame = function CallStackFrame({ frame  }) {
    ...
    }, f.methodName), React.createElement("div", {
        "data-has-source": hasSource ? 'true' : undefined,
        tabIndex: hasSource ? 10 : undefined,
        role: hasSource ? 'link' : undefined,
        onClick: open,
        title: hasSource ? 'Click to open in your editor' : undefined
    }, React.createElement("span", null, (0, _stackFrame).getFrameSource(f)), React.createElement("svg", {
        xmlns: "http://www.w3.org/2000/svg",
        viewBox: "0 0 24 24",
        fill: "none",
        stroke: "currentColor",
...
const RuntimeError = function RuntimeError({ error  }) {
    ...
    return React.createElement(React.Fragment, null, firstFrame ? React.createElement(React.Fragment, null, React.createElement("h5", null, "Source"), leadingFrames.map((frame, index)=>React.createElement(CallStackFrame, {
            key: `leading-frame-${index}-${all}`,
            frame: frame
        })), React.createElement(_codeFrame.CodeFrame, {
        stackFrame: firstFrame.originalStackFrame,
        codeFrame: firstFrame.originalCodeFrame
    })) : undefined, visibleCallStackFrames.length ? React.createElement(React.Fragment, null, React.createElement("h5", null, "Call Stack"), visibleCallStackFrames.map((frame, index)=>React.createElement(CallStackFrame, {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/CodeFrame/styles.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/LeftRightDialogHeader/styles.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Overlay/styles.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Terminal/styles.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Dialog/Dialog.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _interop_require_wildcard = __turbopack_require__("[project-with-next]/node_modules/@swc/helpers/lib/_interop_require_wildcard.js (ecmascript, ssr)").default;
var _object_without_properties_loose = __turbopack_require__("[project-with-next]/node_modules/@swc/helpers/lib/_object_without_properties_loose.js (ecmascript, ssr)").default;
var React = _interop_require_wildcard(__turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react/index.js (ecmascript, ssr)"));
var _useOnClickOutside = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/hooks/use-on-click-outside.js (ecmascript, ssr)");
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Dialog/DialogBody.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Dialog/DialogContent.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Dialog/DialogHeader.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Dialog/styles.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Overlay/Overlay.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _interop_require_default = __turbopack_require__("[project-with-next]/node_modules/@swc/helpers/lib/_interop_require_default.js (ecmascript, ssr)").default;
var _interop_require_wildcard = __turbopack_require__("[project-with-next]/node_modules/@swc/helpers/lib/_interop_require_wildcard.js (ecmascript, ssr)").default;
var _maintainTabFocus = _interop_require_default(__turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Overlay/maintain--tab-focus.js (ecmascript, ssr)"));
var React = _interop_require_wildcard(__turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react/index.js (ecmascript, ssr)"));
var _bodyLocker = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Overlay/body-locker.js (ecmascript, ssr)");
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Terminal/Terminal.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _interop_require_default = __turbopack_require__("[project-with-next]/node_modules/@swc/helpers/lib/_interop_require_default.js (ecmascript, ssr)").default;
var _interop_require_wildcard = __turbopack_require__("[project-with-next]/node_modules/@swc/helpers/lib/_interop_require_wildcard.js (ecmascript, ssr)").default;
var _anser = _interop_require_default(__turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/anser/index.js (ecmascript, ssr)"));
var React = _interop_require_wildcard(__turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react/index.js (ecmascript, ssr)"));
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/LeftRightDialogHeader/LeftRightDialogHeader.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Toast/styles.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Toast/Toast.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/helpers/stack-frame.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/CodeFrame/index.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
var _codeFrame = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/CodeFrame/CodeFrame.js (ecmascript, ssr)");
if ((typeof exports.default === 'function' || typeof exports.default === 'object' && exports.default !== null) && typeof exports.default.__esModule === 'undefined') {
    Object.defineProperty(exports.default, '__esModule', {
        value: true
    });
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/hooks/use-on-click-outside.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Overlay/maintain--tab-focus.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
exports.default = _default;
var _interop_require_default = __turbopack_require__("[project-with-next]/node_modules/@swc/helpers/lib/_interop_require_default.js (ecmascript, ssr)").default;
var _platform = _interop_require_default(__turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/platform/platform.js (ecmascript, ssr)"));
var _cssEscape = _interop_require_default(__turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/css.escape/css.escape.js (ecmascript, ssr)"));
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/Overlay/body-locker.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
"[project-with-next]/node_modules/next/dist/client/components/react-dev-overlay/internal/components/CodeFrame/CodeFrame.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
//# sourceMappingURL=node_modules_next_dist_client_components_layout-router.js.map