(self.TURBOPACK = self.TURBOPACK || []).push(["chunks/ssr/node_modules_next_dist_compiled_react-dom_server.browser.js", {

"[project-with-next]/node_modules/next/dist/compiled/react-dom/server.browser.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {

'use strict';
var l, s;
if (process.env.NODE_ENV === 'production') {
    l = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react-dom/cjs/react-dom-server-legacy.browser.production.min.js (ecmascript, ssr)");
    s = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react-dom/cjs/react-dom-server.browser.production.min.js (ecmascript, ssr)");
} else {
    l = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react-dom/cjs/react-dom-server-legacy.browser.development.js (ecmascript, ssr)");
    s = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react-dom/cjs/react-dom-server.browser.development.js (ecmascript, ssr)");
}
...
"[project-with-next]/node_modules/next/dist/compiled/react-dom/cjs/react-dom-server-legacy.browser.production.min.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {

'use strict';
var aa = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react/index.js (ecmascript, ssr)"), ba = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react-dom/server-rendering-stub.js (ecmascript, ssr)");
function m(a) {
...
'use strict';
var ba = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react/index.js (ecmascript, ssr)"), ca = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react-dom/server-rendering-stub.js (ecmascript, ssr)");
function k(a) {
    for(var b = "https://reactjs.org/docs/error-decoder.html?invariant=" + a, c = 1; c < arguments.length; c++)b += "&args[]=" + encodeURIComponent(arguments[c]);
    return "Minified React error #" + a + "; visit " + b + " for the full message or use the non-minified dev environment for full errors and additional helpful warnings.";
}
...
var Ha = ca.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Dispatcher, Ia = x("<script>"), Ja = x("\x3c/script>"), Ka = x('<script src="'), La = x('<script type="module" src="'), Ma = x('" integrity="'), Na = x('" async="">\x3c/script>'), Oa = /(<\/|<)(s)(cript)/gi;
function Pa(a, b, c, d) {
    return "" + b + ("s" === c ? "\\u0073" : "\\u0053") + d;
}
...
function le(a, b, c) {
    ...
    f ? a.sentCompleteBoundaryFunction ? a.sentStyleInsertionFunction ? q(b, ec) : (a.sentStyleInsertionFunction = !0, q(b, dc)) : (a.sentCompleteBoundaryFunction = !0, a.sentStyleInsertionFunction = !0, q(b, cc)) : a.sentCompleteBoundaryFunction ? q(b, bc) : (a.sentCompleteBoundaryFunction = !0, q(b, ac));
...
function he(a, b) {
    ...
    try {
        ...
        for(c = 0; c < g.length; c++){
            ...
            q(f, m);
            q(f, lc);
            if (t || r || u) q(f, nc), q(f, w(pc(t || "")));
            if (r || u) q(f, nc), q(f, w(pc(r || "")));
            u && (q(f, nc), q(f, w(pc(u))));
            if (!v(f, mc)) {
                a.destination = null;
                c++;
...
if (process.env.NODE_ENV !== "production") {
    (function() {
        'use strict';
        var React = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react/index.js (ecmascript, ssr)");
        var ReactDOM = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react-dom/server-rendering-stub.js (ecmascript, ssr)");
...
"[project-with-next]/node_modules/next/dist/compiled/react-dom/server-rendering-stub.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {

'use strict';
if (process.env.NODE_ENV === 'production') {
    module.exports = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react-dom/cjs/react-dom-server-rendering-stub.production.min.js (ecmascript, ssr)");
} else {
    module.exports = __turbopack_require__("[project-with-next]/node_modules/next/dist/compiled/react-dom/cjs/react-dom-server-rendering-stub.development.js (ecmascript, ssr)");
}
...
//# sourceMappingURL=node_modules_next_dist_compiled_react-dom_server.browser.js.map